...
if __name__ == "__main__":
    ...
    rel_diffs = jnp.round(
        100 * (iminuit_bestfit - optimistix_migrad_bestfit) / optimistix_migrad_bestfit, 2
    )
    ...
    #
    # Difference in bestfit parameters:
    #                             EG_RESOLUTION_ALL: iminuit=+0.0005 vs optimistix.migrad=+0.0005 (rel. diff=+000.4%, abs. diff=0.0000)
    #                                  EG_SCALE_ALL: iminuit=-0.0051 vs optimistix.migrad=-0.0052 (rel. diff=-000.4%, abs. diff=0.0000)
    ...
    #                          FT_EFF_B_systematics: iminuit=-0.0059 vs optimistix.migrad=-0.0059 (rel. diff=+000.4%, abs. diff=0.0000)
    #                          FT_EFF_C_systematics: iminuit=+0.0281 vs optimistix.migrad=+0.0281 (rel. diff=-000.1%, abs. diff=0.0000)
    #                      FT_EFF_Light_systematics: iminuit=-0.0402 vs optimistix.migrad=-0.0402 (rel. diff=-000.0%, abs. diff=0.0000)
    #                          FT_EFF_extrapolation: iminuit=-0.0054 vs optimistix.migrad=-0.0054 (rel. diff=-000.1%, abs. diff=0.0000)
    #               FT_EFF_extrapolation_from_charm: iminuit=+0.0085 vs optimistix.migrad=+0.0085 (rel. diff=-000.1%, abs. diff=0.0000)
    #      JET_EtaIntercalibration_NonClosure_highE: iminuit=-0.0007 vs optimistix.migrad=-0.0007 (rel. diff=-000.0%, abs. diff=0.0000)
    #     JET_EtaIntercalibration_NonClosure_negEta: iminuit=+0.0174 vs optimistix.migrad=+0.0174 (rel. diff=-000.1%, abs. diff=0.0000)
    #     JET_EtaIntercalibration_NonClosure_posEta: iminuit=-0.0005 vs optimistix.migrad=-0.0005 (rel. diff=-000.1%, abs. diff=0.0000)
    ...
    #                               JET_GroupedNP_3: iminuit=+0.0240 vs optimistix.migrad=+0.0240 (rel. diff=-000.2%, abs. diff=0.0001)
    #                              JET_JER_DataVsMC: iminuit=-0.0267 vs optimistix.migrad=-0.0268 (rel. diff=-000.7%, abs. diff=0.0002)
    #                         JET_JER_EffectiveNP_1: iminuit=-0.2798 vs optimistix.migrad=-0.2796 (rel. diff=+000.1%, abs. diff=0.0002)
    #                         JET_JER_EffectiveNP_2: iminuit=-0.2165 vs optimistix.migrad=-0.2157 (rel. diff=+000.4%, abs. diff=0.0008)
    #                         JET_JER_EffectiveNP_3: iminuit=+0.1373 vs optimistix.migrad=+0.1392 (rel. diff=-001.4%, abs. diff=0.0019)
    #                         JET_JER_EffectiveNP_4: iminuit=-0.0262 vs optimistix.migrad=-0.0262 (rel. diff=-000.1%, abs. diff=0.0000)
    #                         JET_JER_EffectiveNP_5: iminuit=-0.0102 vs optimistix.migrad=-0.0103 (rel. diff=-000.1%, abs. diff=0.0000)
    #                         JET_JER_EffectiveNP_6: iminuit=-0.0168 vs optimistix.migrad=-0.0168 (rel. diff=-000.1%, abs. diff=0.0000)
    #                 JET_JER_EffectiveNP_7restTerm: iminuit=-0.0387 vs optimistix.migrad=-0.0388 (rel. diff=-000.2%, abs. diff=0.0001)
    #                             JET_JvtEfficiency: iminuit=-0.0002 vs optimistix.migrad=-0.0000 (rel. diff=+337.5%, abs. diff=0.0001)
    #                          MET_SoftTrk_ResoPara: iminuit=+0.0189 vs optimistix.migrad=+0.0189 (rel. diff=-000.0%, abs. diff=0.0000)
    #                          MET_SoftTrk_ResoPerp: iminuit=-0.0396 vs optimistix.migrad=-0.0397 (rel. diff=-000.2%, abs. diff=0.0001)
    #                             MET_SoftTrk_Scale: iminuit=-0.0615 vs optimistix.migrad=-0.0616 (rel. diff=-000.1%, abs. diff=0.0000)
    ...
    #                                       MUON_ID: iminuit=-0.0144 vs optimistix.migrad=-0.0144 (rel. diff=+000.2%, abs. diff=0.0000)
    #                                       MUON_MS: iminuit=+0.0118 vs optimistix.migrad=+0.0119 (rel. diff=-000.6%, abs. diff=0.0001)
    #                          MUON_SAGITTA_RESBIAS: iminuit=+0.0058 vs optimistix.migrad=+0.0058 (rel. diff=+000.2%, abs. diff=0.0000)
    #                              MUON_SAGITTA_RHO: iminuit=-0.0004 vs optimistix.migrad=-0.0004 (rel. diff=-000.0%, abs. diff=0.0000)
    #                                    MUON_SCALE: iminuit=-0.0023 vs optimistix.migrad=-0.0023 (rel. diff=+000.3%, abs. diff=0.0000)
    #                                     ttbar_FSR: iminuit=+0.0937 vs optimistix.migrad=+0.0936 (rel. diff=+000.1%, abs. diff=0.0001)
    #                                     ttbar_Gen: iminuit=+0.3278 vs optimistix.migrad=+0.3278 (rel. diff=-000.0%, abs. diff=0.0000)
    #                                ttbar_ISR_Down: iminuit=-0.0066 vs optimistix.migrad=-0.0066 (rel. diff=+000.1%, abs. diff=0.0000)
    ...
    #                                        SigRad: iminuit=+0.0000 vs optimistix.migrad=+0.0000 (rel. diff=-091.1%, abs. diff=0.0000)
    #                                    ttH_theory: iminuit=-0.0008 vs optimistix.migrad=-0.0008 (rel. diff=-000.6%, abs. diff=0.0000)
    #                                    ttZ_theory: iminuit=-0.0019 vs optimistix.migrad=-0.0019 (rel. diff=-000.4%, abs. diff=0.0000)
